...
user in an INI file next to KodiDesktopPortable.exe called GitHubDesktopPortable.ini.
...
KodiDesktopPortable.exe. The options in the INI file are as follows:
